...
class ZOOL2(BlackBoxL2):
    def __init__(self, sess, model, height=224, width=224, batch_size=1, num_channels=3, num_labels=1000,
                 ...
                 binary_search_steps=BINARY_SEARCH_STEPS, max_iterations=20000, print_every=10,
                 early_stop_iters=0, abort_early=ABORT_EARLY, initial_const=10.0, use_log=False, use_tanh=False,
                 use_resize=True, adam_beta1=0.9, adam_beta2=0.999, reset_adam_after_found=False, solver="adam",
