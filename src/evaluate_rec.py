...
def parse_args():
    ...
    parser.add_argument('--tp_k_predictions', type=int, default=300, help='top k predictions to store before the evaluation')
...
if __name__ == '__main__':
    ...
    solver.store_predictions('Store Predictions')
